...
extern int Socket_accept(int sockfd, void *addr, socklen_t *addr_size);
extern int Socket_recvfrom(int sockfd, u8 *buffer, int len, void *addr, socklen_t *addr_size);
